...
using Microsoft.ML.Transforms;
    ...
    {
        public const string RetrainFilePath =  @"C:\ML.NET-Projects\TaxiFarePrediction\TaxiFarePrediction\Data\taxi-fare-train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=1790,NumberOfIterations=981,MinimumExampleCountPerLeaf=20,LearningRate=0.3128475890694676,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.7936085870508883,FeatureFraction=0.9655773334988337,L1Regularization=2E-10,L2Regularization=0.9999997766729865},MaximumBinCountPerFeature=287}));
